...
export default function ContextualInquiry() {
  return (
    <div>
      <h3 className="text-2xl font-bold mb-8">Contextual Inquiry</h3>
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        <p className="text-gray-700">
          We observed real-world scenarios where IoT-enabled systems interact with users to understand 
          practical challenges, workflows, and opportunities for improvement.
        </p>
      </div>
